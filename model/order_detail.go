...
func (odm *OrderDetailModel) GetOrderDetailByOrderList(orderIDList []uint32, dishType, dishID uint32) ([]*OrderDetail, error) {
	...
	if dishID != 0 {
		condition += fmt.Sprintf(" AND `dish_id` = %v ", dishID)
	}
